...
//    @IBInspectable
//    var fillImage: UIImage = UIImage(named: "ic_star_fill",in: bundle.self, compatibleWith: nil)! {
//        didSet {
//             updateView()
//        }
//    }
    ...
    @IBInspectable
    var fillImage = UIImage(named: "ic_star_fill", in: Bundle(for: StarRateView.self), compatibleWith: nil)
